...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=62714755ltr&server=1">
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/printview.css?v=5.1.3" media="print" id="printcss">
    <title>localhost:1080 / 127.0.0.1 | phpMyAdmin 5.1.3</title>
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=music&table=users">`music`.`users`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=music&table=songs">`music`.`songs`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=music&table=songs_list">`music`.`songs_list`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=geet&table=playlistsongs">`geet`.`playlistsongs`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=geet&table=playlists">`geet`.`playlists`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=geet&table=songs">`geet`.`songs`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=geet&table=users">`geet`.`users`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=my_music&table=songs_list">`my_music`.`songs_list`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=registration&table=registration">`registration`.`registration`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=project&table=songs">`project`.`songs`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="722e477624586664574f5f3d7d405b6d">
  ...
  <div id="pma_console_container">
    <div id="pma_console">
                ...
                <div class="message welcome">
                    ...
                    <span class="hide" id="instructions-1">
                        Press Enter to execute query                    </span>
                            ...
                            targetdb="music" targettable="songs_list">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `songs_list`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="music" targettable="songs">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `songs`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="music" targettable="users">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
